...
function obj:moveAndResize(option)
    ...
    if cwin then
        ...
        elseif option == "onethirdleft" then
            cwin:setFrame({x=cres.x, y=cres.y, w=cres.w/3, h=cres.h})
        elseif option == "onethirdright" then
            cwin:setFrame({x=cres.x+cres.w/3*2, y=cres.y, w=cres.w/3, h=cres.h})
        elseif option == "onethirdup" then
            cwin:setFrame({x=cres.x, y=cres.y, w=cres.w, h=cres.h/3})
        elseif option == "onethirddown" then
            cwin:setFrame({x=cres.x, y=cres.y+cres.h/3*2, w=cres.w, h=cres.h/3})
        ...
        elseif option == "twothirdsup" then
            cwin:setFrame({x=cres.x, y=cres.y, w=cres.w, h=cres.h/3*2})
        elseif option == "twothirdsdown" then
            cwin:setFrame({x=cres.x, y=cres.y+cres.h/3, w=cres.w, h=cres.h/3*2})
